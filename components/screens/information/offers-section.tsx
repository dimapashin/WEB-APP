...
const OFFERS = [
  ...
  {
    id: 4,
    title: "Специальные предложения для корпоративных клиентов",
    description: "Индивидуальные условия для компаний и организаций",
    icon: Users,
    details: [
    ...
    note: "Свяжитесь с нами для получения персонального предложения",
  },
]
